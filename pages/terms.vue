<template>
  <div class="section container">
    ...
    <p>
      ...
      to bring the citizens of the world together to build new cooperations. For
      every natural person only one referral account is allowed. You are
      prohibited to create several users or accounts in order to advance
      yourself in the greenfluencer ranking. Any violation or attempt of rigging
      the referral campagin will result in exclusion of using our website and
      services. We will hold the right to verify your identity in order to
      unlock your flatrate voucher.
      <br />At the point of time, on 16.07.2019, when this campaign website was
      ...
      <b>NOT</b> promise any delivery of intended services. The successful
      delivery of our vision depends on the external partners, who are providing
      the services an accepting the vouchers. The referral greenfluencer rewards
      will only be validated and verified after a successful crowdfunding, for
      which there will be updated terms of services, before we launch the
    ...
    <p>
      ...
      means if you click on the link and purchase an item, Website Operator will
      receive an affiliate commission. We are not responsible for examining or
      ...
      statements and other conditions of use of any website which you access
      through a link from this Website. Your linking to any other off-site
    ...
    <p>
      ...
      Website Operator or third-parties, and all rights, titles, and interests
      in and to such property will remain (as between the parties) solely with
      Website Operator. All trademarks, service marks, graphics and logos used
      in connection with our Website or Services, are trademarks or registered
      trademarks of Website Operator or Website Operator licensors. Other
    ...
    <p>
      ...
      procedural laws of Bayern, Germany without regard to its rules on
      conflicts or choice of law and, to the extent applicable, the laws of
      Germany. The exclusive jurisdiction and venue for actions related to the
      subject matter hereof shall be the state and federal courts located in
      Bayern, Germany, and you hereby submit to the personal jurisdiction of
...
// import OmoTerms from "@/components/OmoTerms.vue";
