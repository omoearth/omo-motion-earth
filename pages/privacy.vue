<template>
  <div class="container section">
    ...
    <p>The use of the Facebook plug-in is based on Art. 6 Sect. 1 lit. f GDPR. The operator of the website has a legitimate interest in being as visible as possible on social media.</p>
    ...
    <p>We have integrated functions of the chat platform Telegram into this website. These functions are being offered by Telegram Messenger LLP, 71-75 Shelton Street Covent Garden London United Kingdom.</p>
    <p>If you are logged into your Telegram account, you may click the Telegram button to link contents from this website to your Telegram profile. This enables Telegram to allocate your visit to this website to your user account. We have to point out that we as the provider of the website and its pages do not have any knowledge of the content of the data transferred and its use by Telegram.</p>
    <p>The use of the Telegram plug-in is based on Art. 6 Sect. 1 lit. f GDPR. The operator of the website has a legitimate interest in being as visible as possible on social media.</p>
    <p>
      For more information on this subject, please consult Telegram Data Privacy Declaration at:
      <a
    ...
    <p>This website uses functions of the LinkedIn network. The provider is LinkedIn Corporation, 2029 Stierlin Court, Mountain View, CA 94043, USA.</p>
    ...
    <h3>Referral Hero</h3>
    <p>
      This website embeds a referral campagin tool from referralhero.com. The website operator is Sparktech Software Ltd
      102 Bromstone Road, Broadstairs, United Kingdom, CT10 2HX
    </p>
    <p>If you visit a page on this website into which the referral campaign tool has been embedded, a connection with referralhero.com servers will be established. As a result, the referralhero.com server will be notified, which of our pages you have visited.</p>
    <p>Furthermore, referralhero.com will be able to place various cookies on your device. With the assistance of these cookies, referralhero.com will be able to obtain information about this website's visitors. Among other things, this information will be used to generate statistics with the aim of improving the user friendliness of the site and to prevent attempts to commit fraud. These cookies will stay on your device until you delete them.</p>
    <p>If you are logged into your referralhero.com account while you visit our site, you enable referralhero.com to directly allocate your browsing patterns to your personal profile. You have the option to prevent this by requesting the deletion of your referralhero.com account.</p>
    <p>The use of referralhero.com is based on our interest in presenting our online content in an appealing manner. Pursuant to Art. 6 Sect. 1 lit. f GDPR, this is a legitimate interest. If a corresponding agreement has been requested (e.g. an agreement to the storage of cookies), the processing takes place exclusively on the basis of Art. 6 para. 1 lit. a GDPR; the agreement can be revoked at any time.</p>
    <p>
      For more information on how referralhero.com handles user data, please consult the referralhero.com Data Privacy Policy under:
      <a
    ...
    <h3>Crisp Chat</h3>
    <p>This website embeds a customer chat and contact form tool from crisp chat. The website operator is Crisp IM SARL a company registered at 2 Boulevard de Launay, 44100 Nantes, France (registration number: 833085806)</p>
    <p>If you visit a page on this website into which the crisp chat has been embedded, a connection with the crisp chat servers will be established. As a result, the crisp chat server will be notified, which of our pages you have visited.</p>
    <p>Furthermore, crisp chat will be able to place various cookies on your device. With the assistance of these cookies, crisp chat will be able to obtain information about this website's visitors. Among other things, this information will be used to generate statistics with the aim of improving the user friendliness of the site and to prevent attempts to commit fraud. These cookies will stay on your device until you delete them.</p>
    <p>If you are logged into your crisp chat account while you visit our site, you enable crisp chat to directly allocate your browsing patterns to your personal profile. You have the option to prevent this by requesting the deletion of your crisp chat account.</p>
    <p>The use of crisp chat is based on our interest in presenting our online content in an appealing manner. Pursuant to Art. 6 Sect. 1 lit. f GDPR, this is a legitimate interest. If a corresponding agreement has been requested (e.g. an agreement to the storage of cookies), the processing takes place exclusively on the basis of Art. 6 para. 1 lit. a GDPR; the agreement can be revoked at any time.</p>
    <p>
      For more information on how crisp chat handles user data, please consult the crisp chat Data Privacy Policy under:
      <a
    ...
    <p>To do this, the browser you use will have to establish a connection with Google’s servers. As a result, Google will learn that your IP address was used to access this website. The use of Google Web Fonts is based on our interest in presenting our online content in a uniform and appealing way. According to Art. 6 Sect. 1 lit. f GDPR, this is a legitimate interest.</p>
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
      >https://developers.google.com/fonts/faq</a> and consult Google’s Data Privacy Declaration under:
      <a
        href="https://policies.google.com/privacy?hl=en"
        target="_blank"
        rel="noopener noreferrer"
