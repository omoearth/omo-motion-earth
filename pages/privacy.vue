<template>
  <div class="container section">
    ...
    <p>
      ...
      whose contact information is available under section „Information Required
      by Law“ on this website.
    </p>
    <p>
    ...
    <p>
      ...
      data are rectified or eradicated. Please do not hesitate to contact us at
      any time under the address disclosed in section „Information Required by
    ...
    <p>
      ...
      interest of secure, fast and efficient provision of our online services by
      a professional provider (Art. 6 para. 1 lit. f DSGVO).
    </p>
    <p>
    ...
    <p>
      ...
      of the requests addressed to us (Art. 6 Para. 1 lit. f DSGVO) or on your
      agreement (Art. 6 Para. 1 lit. a DSGVO) if this has been requested.
    </p>
    <p>
    ...
    <p>
      ...
      Facebook Inc., 1 Hacker Way, Menlo Park, California 94025, USA, on this
      website. You will be able to recognise Facebook plug-ins by the Facebook
      logo or the „Like“ button on this website. An overview of the Facebook
      plug-ins is available under the following link:
      <a
    ...
    <p>
      ...
      your Facebook account while you are on this website.
    </p>
    <p>
    ...
    <p>
      We have integrated functions of the chat platform Telegram into this
      website. These functions are being offered by Telegram Messenger LLP,
      71-75 Shelton Street Covent Garden London United Kingdom.
    </p>
    <p>
      If you are logged into your Telegram account, you may click the Telegram
      button to link contents from this website to your Telegram profile. This
      enables Telegram to allocate your visit to this website to your user
      account. We have to point out that we as the provider of the website and
      its pages do not have any knowledge of the content of the data transferred
      and its use by Telegram.
    </p>
    <p>
      The use of the Telegram plug-in is based on Art. 6 Sect. 1 lit. f GDPR.
      The operator of the website has a legitimate interest in being as visible
      as possible on social media.
    </p>
    <p>
      For more information on this subject, please consult Telegram Data Privacy
      Declaration at:
      <a
    ...
    <p>
      If you are logged into your Instagram account, you may click the Instagram
      button to link contents from this website to your Instagram profile. This
      enables Instagram to allocate your visit to this website to your user
      account. We have to point out that we as the provider of the website and
      its pages do not have any knowledge of the content of the data transferred
    ...
    <p>
      ...
      LinkedIn, a connection to LinkedIn’s servers is established. LinkedIn is
      notified that you have visited this website with your IP address. If you
      click on LinkedIn’s „Recommend“ button and are logged into your LinkedIn
      account at the time, LinkedIn will be in a position to allocate your visit
      to this website to your user account. We have to point out that we as the
      provider of the websites do not have any knowledge of the content of the
      transferred data and its use by LinkedIn.
    </p>
    <p>
      The use of the LinkedIn plug-in is based on Art. 6 Sect. 1 lit. f GDPR.
      The operator of the website has a legitimate interest in being as visible
      as possible on social media.
    </p>
    <p>
    ...
    <p>
      ...
      We shall use such data only for the sending of the requested information
    ...
    <h3>Referral Hero</h3>
    <p>
      This website embeds a referral campagin tool from referralhero.com. The
      website operator is Sparktech Software Ltd 102 Bromstone Road,
      Broadstairs, United Kingdom, CT10 2HX
    </p>
    <p>
      If you visit a page on this website into which the referral campaign tool
      has been embedded, a connection with referralhero.com servers will be
      established. As a result, the referralhero.com server will be notified,
      which of our pages you have visited.
    </p>
    <p>
      Furthermore, referralhero.com will be able to place various cookies on
      your device. With the assistance of these cookies, referralhero.com will
      be able to obtain information about this website's visitors. Among other
      things, this information will be used to generate statistics with the aim
    ...
    <p>
      If you are logged into your referralhero.com account while you visit our
      site, you enable referralhero.com to directly allocate your browsing
      patterns to your personal profile. You have the option to prevent this by
      requesting the deletion of your referralhero.com account.
    </p>
    <p>
      The use of referralhero.com is based on our interest in presenting our
      online content in an appealing manner. Pursuant to Art. 6 Sect. 1 lit. f
      GDPR, this is a legitimate interest. If a corresponding agreement has been
    ...
    <p>
      For more information on how referralhero.com handles user data, please
      consult the referralhero.com Data Privacy Policy under:
      <a
    ...
    <h3>Crisp Chat</h3>
    <p>
      This website embeds a customer chat and contact form tool from crisp chat.
    ...
    <p>
      If you visit a page on this website into which the crisp chat has been
      embedded, a connection with the crisp chat servers will be established. As
      a result, the crisp chat server will be notified, which of our pages you
      have visited.
    </p>
    <p>
      Furthermore, crisp chat will be able to place various cookies on your
      device. With the assistance of these cookies, crisp chat will be able to
      obtain information about this website's visitors. Among other things, this
      information will be used to generate statistics with the aim of improving
      the user friendliness of the site and to prevent attempts to commit fraud.
      These cookies will stay on your device until you delete them.
    </p>
    <p>
      If you are logged into your crisp chat account while you visit our site,
      you enable crisp chat to directly allocate your browsing patterns to your
      personal profile. You have the option to prevent this by requesting the
      deletion of your crisp chat account.
    </p>
    <p>
      The use of crisp chat is based on our interest in presenting our online
    ...
    <p>
      For more information on how crisp chat handles user data, please consult
      the crisp chat Data Privacy Policy under:
      <a
    ...
    <h3>YouTube</h3>
    <p>
      This website embeds videos of the website YouTube. The website operator is
    ...
    <p>
      ...
      With the assistance of these cookies, YouTube will be able to obtain
    ...
    <p>
      ...
      has been integrated, a connection to Vimeo’s servers will be established.
      As a consequence, the Vimeo server will receive information as to which of
      our pages you have visited. Moreover, Vimeo will receive your IP address.
      This will also happen if you are not logged into Vimeo or do not have an
      account with Vimeo. The information recorded by Vimeo will be transmitted
      to Vimeo’s server in the United States.
    </p>
    <p>
      If you are logged into your Vimeo account, you enable Vimeo to directly
      allocate your browsing patterns to your personal profile. You can prevent
      this by logging out of your Vimeo account.
    </p>
    <p>
      The use of Vimeo is based on our interest in presenting our online content
      in an appealing manner. Pursuant to Art. 6 Sect. 1 lit. f GDPR, this is a
      legitimate interest. If a corresponding agreement has been requested (e.g.
      an agreement to the storage of cookies), the processing takes place
    ...
    <p>
      ...
      Google’s servers. As a result, Google will learn that your IP address was
      used to access this website. The use of Google Web Fonts is based on our
      interest in presenting our online content in a uniform and appealing way.
