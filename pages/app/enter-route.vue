...
<script>
import LocationChooser from "~/components/legacy/LocationChooser";
    ...
    refreshMap() {
      ...
      this.$nextTick(() => {
        ...
        if (this.startLocation) {
          this.startLocationMarker = L.marker(
        ...
        if (this.destinationLocation) {
          this.destinationLocationMarker = L.marker(
        ...
        if (this.startLocation && this.destinationLocation) {
          let closestVehicleLayer = L.GeometryUtil.closestLayer(
            map,
            this.vehicleLayers,
            {
          ...
          if (closestVehicleLayer) {
            waypoints = [
              ...
              L.latLng(
                closestVehicleLayer.latlng.lat,
                closestVehicleLayer.latlng.lng
              ),
              L.latLng(
