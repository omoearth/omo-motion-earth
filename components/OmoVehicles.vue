<template>
  <div>
    <div class="section has-text-centered is-medium">
      ...
      >or just enjoy the freedom</div>
      <div class="subtitle is-size-3 is-size-4-tablet is-size-6-mobile has-text-dark">
    ...
    >
      ...
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          <img src="/products/bike.svg" width="55%" style="padding-bottom: 1rem">
          <div class="title is-size-2 is-size-4-mobile">Flat XS</div>
          <div class="subtitle is-size-4 is-size-6-mobile">non-electric bikes</div>
        </div>
      </div>
    </div>
    <div
    ...
    >
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          <img src="/products/pedelec.svg" width="65%" style="padding-bottom: 1rem">
          <div class="title is-size-2 is-size-4-mobile">eFlat S</div>
          <div class="subtitle is-size-4 is-size-6-mobile">mini-scooter & pedelec add-on</div>
        </div>
      </div>
      <div class="column is-half">
    ...
    >
      ...
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          ...
          <div class="subtitle is-size-4 is-size-6-mobile">eScooter add-on</div>
        </div>
      </div>
    </div>
    <div
    ...
    >
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          ...
          <div class="subtitle is-size-4 is-size-6-mobile">mini eCar (2-4 seats) add-on</div>
        </div>
      </div>
      <div class="column is-half">
    ...
    >
      ...
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          <img src="/products/car.svg" width="85%" style="padding-bottom: 1rem">
          <div class="title is-size-2 is-size-4-mobile">eFlat XL</div>
          <div class="subtitle is-size-4 is-size-6-mobile">eCar (5+ seats) add-on</div>
        </div>
      </div>
    </div>
    <div
    ...
    >
      ...
      <div class="column is-half is-centered">
        <div class="has-text-centered">
          ...
          <div class="subtitle is-size-4 is-size-6-mobile">eTrain & eBus add-on</div>
        </div>
      </div>
    </div>
  </div>
