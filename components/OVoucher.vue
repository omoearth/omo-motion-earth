<template>
  <div>
    ...
    <br>
    <br>
    <div class="button" @click="createStellarAccount()">Create NEW Account</div>
    <div class="button" @click="getNEWAccountBalance(NEWpublicKey)">Get NEW Account Balance</div>
    <div class="button" @click="transferMoney(OMOsecret, OMOpublicKey)">Transfer Money</div>
    <br>
    <br>NEW ACCOUNT:
    <br>publicKey:
